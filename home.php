...
<div class="col-lg-12 py-5">
  ...
  <div class="footer-content">
    <div class="footer-section about">
      ...
      <div class="contact">
        <span> &nbsp; <i class="fa fa-phone"></i> &nbsp; 0967-754-4502 </span><br><br>
        <span> &nbsp; <i class="fa fa-phone"></i> &nbsp; 0964-395-2863 </span>
      </div>
      <div class="socials">
        <br>
        <a href="https://www.facebook.com/Clickyours-108272428621319">
        &nbsp;<span>&nbsp;<ion-icon name="logo-facebook"></ion-icon>&nbsp; &nbsp; Facebook</a></span>
      </div>
    </div>
  </div>
</div>
